...
const swiperPopular = new Swiper('.popular__swipper', {
    loop: true,
    grabCursor: true,
    slidesPerView:'auto',
    centeredSlides: 'auto'
...
sr.reveal(`.home__board`, {delay: 700, distance:'1000px' , origin: 'right'});
sr.reveal(`.home__pizza`, {delay: 1400, distance:'1000px' , origin: 'bottom', rotate: {z: -90}});
